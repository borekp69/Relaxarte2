...
<? 
    ...
    echo '<option value = "' .$row["spolecnost_id"]. '">&nbsp;' .$row["spolecnost_nazev"]. "</option>\n"; 
     ...
     $result = $conn->query($sql); 
     while($row = $result->fetch_assoc()) {     
            if ($row["spolecnost_id"] == $uzivatel_spolecnost){
...
<? radky(3,"Příjmení:", $chyba_prijmeni) ?>      
...
<input type="text" maxlength="100" class="form-control form-control-sm" name="ulice" value = "<?echo $uzivatel_ulice;?>" placeholder="Název ulice" required>
</div> 
</div>
<? radky(2,"Číslo popisné:", $chyba_cp) ?>       
<input type="text" maxlength="50" onkeypress="return isNumberKey(event)" class="form-control form-control-sm" name="cislo_popisne" value = "<?echo $uzivatel_cp;?>" placeholder="Číslo popisné" required>
</div>   
</div>
<? radky(2,"Číslo orientační:", $chyba_co) ?>  
<input type="text" class="form-control form-control-sm" maxlength="50" name="cislo_orientacni" value = "<?echo $uzivatel_co;?>" placeholder="Číslo orientační">
</div>   
</div>  
</div>  
...
<input type="text" class="form-control form-control-sm" maxlength="100" name="mesto" value = "<?echo $uzivatel_mesto;?>" placeholder="Název obce" required>
</div> 
</div>
<? radky(1,"PSČ:", $chyba_psc) ?>   
<input type="text" onkeypress="return isNumberKey(event)" class="form-control form-control-sm" name="psc" maxlength="5" minlength="5"  value = "<?echo $uzivatel_psc;?>" placeholder="PSČ" required>
</div>   
</div>
</div>

<div class="row">
<? radky(3,"E-mail:", $chyba_email) ?>   
<input type="email" class="form-control form-control-sm" name="email" maxlength="100" value = "<?echo $uzivatel_email;?>" placeholder="např. jmeno.prijmeni@domena.com" required>
</div> 
</div>
...
<? radky(3,"Telefon:", $chyba_mobil) ?>   
<input type="text" onkeypress="return isNumberKey(event)" class="form-control form-control-sm" name="mobil" maxlength="9" value = "<?echo $uzivatel_mobil;?>"  placeholder="Telefonní číslo" required>
</div>                      
</div>  
</div> 
...
<div class="row">
<? radky(4,"Jste registrován/a u některého našeho lékaře:", $chyba_lekar) ?>      
