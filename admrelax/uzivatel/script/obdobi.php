...
$sql_tcm_nejhorsi_obdobi= "SELECT * FROM tcm_nejhorsi_obdobi WHERE uzivatel_id = $uzivatel_id ORDER BY datum LIMIT 1";
$result_tcm_nejhorsi_obdobi = $conn->query($sql_tcm_nejhorsi_obdobi);
$conn->close();
$pocet_tcm_nejhorsi_obdobi = mysqli_num_rows($result_tcm_nejhorsi_obdobi);
//echo "ID: ".$uzivatel_id;
//echo "<br>";
...
if($pocet_tcm_nejhorsi_obdobi == 0){

    require $_SERVER['DOCUMENT_ROOT']."/admrelax/db/pripojeni_databaze.php";
    $sql = "INSERT INTO tcm_nejhorsi_obdobi (
     uzivatel_id,
     datum
        )
    VALUES (
