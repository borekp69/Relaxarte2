...
$tcm_fyzicke_telo_voda_form = addslashes(htmlspecialchars(trim("$_POST[fyzicke_telo_voda]")));
$tcm_fyzicke_telo_drevo_form = addslashes(htmlspecialchars(trim("$_POST[fyzicke_telo_drevo]")));
$tcm_fyzicke_telo_kov_form = addslashes(htmlspecialchars(trim("$_POST[fyzicke_telo_kov]")));
$tcm_fyzicke_telo_zeme_form = addslashes(htmlspecialchars(trim("$_POST[fyzicke_telo_zeme]")));
$tcm_fyzicke_telo_ohen_form = addslashes(htmlspecialchars(trim("$_POST[fyzicke_telo_ohen]")));

$psychika_voda_form = addslashes(htmlspecialchars(trim("$_POST[psychika_voda]")));
$psychika_drevo_form = addslashes(htmlspecialchars(trim("$_POST[psychika_drevo]")));
$psychika_kov_form = addslashes(htmlspecialchars(trim("$_POST[psychika_kov]")));
$psychika_zeme_form = addslashes(htmlspecialchars(trim("$_POST[psychika_zeme]")));
$psychika_ohen_form = addslashes(htmlspecialchars(trim("$_POST[psychika_ohen]")));

//echo "ID: ".$uzivatel_id."<br>";
//echo "tcm_telo_voda:".$tcm_fyzicke_telo_voda_form."<br>";
//echo "tcm_telo_drevo:".$tcm_fyzicke_telo_drevo_form."<br>";
//echo "tcm_telo_kov:".$tcm_fyzicke_telo_kov_form."<br>";
//echo "tcm_telo_zeme:".$tcm_fyzicke_telo_zeme_form."<br>";
//echo "tcm_telo_ohen:".$tcm_fyzicke_telo_ohen_form."<br>";

//echo "psychika_voda:".$psychika_voda_form."<br>";
//echo "psychika_drevo:".$psychika_drevo_form."<br>";
//echo "psychika_kov:".$psychika_kov_form."<br>";
//echo "psychika_zeme:".$psychika_zeme_form."<br>";
//echo "psychika_ohen:".$psychika_ohen_form."<br>";

require $_SERVER['DOCUMENT_ROOT']."/admrelax/db/pripojeni_databaze.php";

$sql = "UPDATE tcm_telo SET 
    tcm_telo_voda = '$tcm_fyzicke_telo_voda_form',  
    tcm_telo_drevo ='$tcm_fyzicke_telo_drevo_form',
    tcm_telo_kov = '$tcm_fyzicke_telo_kov_form',
    tcm_telo_zeme ='$tcm_fyzicke_telo_zeme_form',   
    tcm_telo_ohen = '$tcm_fyzicke_telo_ohen_form',   
    datum =  NOW()
    WHERE uzivatel_id = '$uzivatel_id'";

    if ($conn->query($sql) === TRUE) {    
    } else {
  echo '<br><div class="alert alert-danger" role="alert"><b>Došlo k následující chybě DB - tcm_telo  :</b><hr>' . $conn->error . '</div>';
    }
    $conn->close(); 
    ...
    require $_SERVER['DOCUMENT_ROOT']."/admrelax/db/pripojeni_databaze.php";
    $sql = "UPDATE tcm_psychika SET 
        tcm_psychika_voda = '$psychika_voda_form', 
        tcm_psychika_drevo = '$psychika_drevo_form',
        tcm_psychika_kov = '$psychika_kov_form',
        tcm_psychika_zeme = '$psychika_zeme_form',    
        tcm_psychika_ohen ='$psychika_ohen_form',    
        datum =  NOW()
        WHERE uzivatel_id = '$uzivatel_id'";
    
        if ($conn->query($sql) === TRUE) {    
        } else {
      echo '<br><div class="alert alert-danger" role="alert"><b>Došlo k následující chybě DB - tcm_psychika :</b><hr>' . $conn->error . '</div>';
        }
        $conn->close(); 
