...
$tcm_snasenlivost_chlad_potreba_form = addslashes(htmlspecialchars(trim("$_POST[tcm_snasenlivost_chlad_potreba]")));
$tcm_snasenlivost_chlad_odpor_form = addslashes(htmlspecialchars(trim("$_POST[tcm_snasenlivost_chlad_odpor]")));
$tcm_snasenlivost_chlad_spatne_form = addslashes(htmlspecialchars(trim("$_POST[tcm_snasenlivost_chlad_spatne]")));
$tcm_snasenlivost_chlad_dobre_form = addslashes(htmlspecialchars(trim("$_POST[tcm_snasenlivost_chlad_dobre]")));
$tcm_snasenlivost_chlad_pocit_sucha_form = addslashes(htmlspecialchars(trim("$_POST[tcm_snasenlivost_chlad_pocit_sucha]")));
$tcm_snasenlivost_chlad_pocit_vlhka_form = addslashes(htmlspecialchars(trim("$_POST[tcm_snasenlivost_chlad_pocit_vlhka]")));
$tcm_snasenlivost_chlad_pocit_vetru_form = addslashes(htmlspecialchars(trim("$_POST[tcm_snasenlivost_chlad_pocit_vetru]")));
$tcm_snasenlivost_chlad_chladne_obklady_form = addslashes(htmlspecialchars(trim("$_POST[tcm_snasenlivost_chlad_chladne_obklady]")));
$tcm_snasenlivost_chlad_zhorseni_stavu_form = addslashes(htmlspecialchars(trim("$_POST[tcm_snasenlivost_chlad_zhorseni_stavu]")));
$tcm_snasenlivost_chlad_zlepseni_stavu_form = addslashes(htmlspecialchars(trim("$_POST[tcm_snasenlivost_chlad_zlepseni_stavu]")));

$tcm_snasenlivost_teplo_potreba_form = addslashes(htmlspecialchars(trim("$_POST[tcm_snasenlivost_teplo_potreba]")));
$tcm_snasenlivost_teplo_odpor_form = addslashes(htmlspecialchars(trim("$_POST[tcm_snasenlivost_teplo_odpor]")));
$tcm_snasenlivost_teplo_spatne_form = addslashes(htmlspecialchars(trim("$_POST[tcm_snasenlivost_teplo_spatne]")));
$tcm_snasenlivost_teplo_dobre_form = addslashes(htmlspecialchars(trim("$_POST[tcm_snasenlivost_teplo_dobre]")));
$tcm_snasenlivost_teplo_potreba_slunce_form = addslashes(htmlspecialchars(trim("$_POST[tcm_snasenlivost_teplo_potreba_slunce]")));
$tcm_snasenlivost_teplo_oteklost_form = addslashes(htmlspecialchars(trim("$_POST[tcm_snasenlivost_teplo_oteklost]")));
$tcm_snasenlivost_teplo_koupele_form = addslashes(htmlspecialchars(trim("$_POST[tcm_snasenlivost_teplo_koupele]")));
$tcm_snasenlivost_teplo_obklady_form = addslashes(htmlspecialchars(trim("$_POST[tcm_snasenlivost_teplo_obklady]")));
$tcm_snasenlivost_teplo_zhorseni_stavu_form = addslashes(htmlspecialchars(trim("$_POST[tcm_snasenlivost_teplo_zhorseni_stavu]")));
$tcm_snasenlivost_teplo_zlepseni_stavu_form = addslashes(htmlspecialchars(trim("$_POST[tcm_snasenlivost_teplo_zlepseni_stavu]")));
$tcm_snasenlivost_zimomrivost_horko_form = addslashes(htmlspecialchars(trim("$_POST[tcm_snasenlivost_zimomrivost_horko]")));

require $_SERVER['DOCUMENT_ROOT']."/admrelax/db/pripojeni_databaze.php";
$sql = "UPDATE tcm_snasenlivost SET
    tcm_snasenlivost_chlad_potreba = '$tcm_snasenlivost_chlad_potreba_form',
    tcm_snasenlivost_chlad_odpor = '$tcm_snasenlivost_chlad_odpor_form',
    tcm_snasenlivost_chlad_spatne = '$tcm_snasenlivost_chlad_spatne_form',
    tcm_snasenlivost_chlad_dobre = '$tcm_snasenlivost_chlad_dobre_form',
    tcm_snasenlivost_chlad_pocit_sucha = '$tcm_snasenlivost_chlad_pocit_sucha_form',   
    tcm_snasenlivost_chlad_pocit_vlhka = '$tcm_snasenlivost_chlad_pocit_vlhka_form',     
    tcm_snasenlivost_chlad_pocit_vetru = '$tcm_snasenlivost_chlad_pocit_vetru_form',
    tcm_snasenlivost_chlad_chladne_obklady = '$tcm_snasenlivost_chlad_chladne_obklady_form', 
    tcm_snasenlivost_chlad_zhorseni_stavu =  '$tcm_snasenlivost_chlad_zhorseni_stavu_form', 
    tcm_snasenlivost_chlad_zlepseni_stavu  = '$tcm_snasenlivost_chlad_zlepseni_stavu_form',
    tcm_snasenlivost_teplo_potreba = '$tcm_snasenlivost_teplo_potreba_form',
    tcm_snasenlivost_teplo_odpor = '$tcm_snasenlivost_teplo_odpor_form',
    tcm_snasenlivost_teplo_spatne = '$tcm_snasenlivost_teplo_spatne_form',
    tcm_snasenlivost_teplo_dobre = '$tcm_snasenlivost_teplo_dobre_form',
    tcm_snasenlivost_teplo_potreba_slunce ='$tcm_snasenlivost_teplo_potreba_slunce_form', 
    tcm_snasenlivost_teplo_oteklost = '$tcm_snasenlivost_teplo_oteklost_form',
    tcm_snasenlivost_teplo_koupele = '$tcm_snasenlivost_teplo_koupele_form',
    tcm_snasenlivost_teplo_obklady = '$tcm_snasenlivost_teplo_obklady_form',
    tcm_snasenlivost_teplo_zhorseni_stavu =  '$tcm_snasenlivost_teplo_zhorseni_stavu_form', 
    tcm_snasenlivost_teplo_zlepseni_stavu  =  '$tcm_snasenlivost_teplo_zlepseni_stavu_form',
    tcm_snasenlivost_zimomrivost_horko  =  '$tcm_snasenlivost_zimomrivost_horko_form',
    datum =  NOW()
