...
$hledat = $_GET['term'];
$hledat = trim($hledat);
$hledat = ucfirst($hledat);
$hledat = encrypt_decrypt('encrypt', $hledat);
	...
	try {
        ...
        FROM uzivatel WHERE uzivatel_prijmeni LIKE '%".$hledat."%' AND uzivatel_role = 3  OR  uzivatel_jmeno LIKE '%".$hledat."%' AND uzivatel_role = 3  OR  uzivatel_rc LIKE '%".$hledat."%' AND uzivatel_role = 3
                ");
