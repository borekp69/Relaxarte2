...
<div class="row">
    ...
    <textarea class="form-control" id="operace_vnitrnich_organu" name="operace_vnitrnich_organu" placeholder="Uveďte operace vnitřních orgánů včetně roku, pokud víte." rows="4" maxlength="300"></textarea>
    </div>
</div>
...
<div class="row">
    ...
    <textarea class="form-control" id="operace_pater_kosti_klouby" name="operace_pater_kosti_klouby" placeholder="Uveďte operace páteře, kostí a kloubů včetně roku, pokud víte." rows="4" maxlength="300"></textarea>
    </div>
</div>
...
<h4>Úrazy</h4>
    ...
    <textarea class="form-control" id="urazy_zlomeniny" name="urazy_zlomeniny" placeholder="Uveďte úrazy (zlomeniny, pohmožděniny, pády na hlavu, kostrč) včetně roku a popisu události, pokud víte." rows="4" maxlength="250"></textarea>
    </div>
</div>
<br>
</div></div>
...
<div class="row">
    ...
    <div class="col-sm-2" style="background-color:#99e6e6;"> 
        <div id="dvartritida_osteoartritida" style="display: none">        
            ...
            <div class="checkbox">
            <label><input type="checkbox" name="artritida_osteoartritida_zapesti" value="1">Zápěstí</label> 
            </div>
...
<div class="row">
    ...
    <textarea class="form-control" id="poloha_vyvolavajici_bolest" name="poloha_vyvolavajici_bolest" placeholder="Uveďte činnost nebo polohu, vyvolávající bolest." rows="4" maxlength="250"></textarea>
    </div>

    <div class="col-sm-6">
    <label for="uzivatel">Úlevová činnost/poloha:</label>
    <textarea class="form-control" id="poloha_ulevova" name="poloha_ulevova" placeholder="Uveďte úlevovou činnost nebo polohu." rows="4" maxlength="250"></textarea>
    </div>
</div>
<br>
...
<div class="row">
    ...
    <textarea class="form-control" id="omezeni_pri_cinnostech" name="omezeni_pri_cinnostech" placeholder="Uveďte omezující činost." rows="4" maxlength="250"></textarea>
    </div>
</div>
<br>
...
<div class="row">
    ...
    <select class="form-control" id="gynekologie_tehotenstvi" name="gynekologie_tehotenstvi">
    ...
    <select class="form-control" id="zobrazmenstruace" name="gynekologie_menstruace">
    ...
    <select class="form-control" id="mnozstvi_krve" name="gynekologie_mnozstvi_krve">
    ...
    <input type="text" onkeypress="return isNumberKey(event)" class="form-control form-control-sm" name="gynekologie_delka_menstruace" maxlength="2" value = "" placeholder="Uveďte počet dní.">
    </div>
    <div class="col-sm-4">
    <label>Bolesti během menstruace:</label>    
    <textarea class="form-control" id="bolesti_behem_menstruace" name="gynekologie_bolesti_behem_menstruace" placeholder="Uveďte bolesti během menstruace." rows="1" maxlength="100"></textarea>
    </div>
     </div>
...
<div class="col-sm-12" style="background-color:#E0E0E0;">
    ...
    <div class="checkbox">
    <label><input type="checkbox" name="interna_gastro_zaludecni_vredy" value="1">Žaludeční vředy</label> 
    </div>
...
<div class="row">
    ...
    <textarea class="form-control" id="onkologie" name="onkologie" placeholder="Uveďte orgán a rok, pokud víte." rows="4" maxlength="250"></textarea>
    </div>
    </div>
    <br>
    </div>
...
<div class="row">
    ...
    <option value="0">ne - neléčil/a</option>
    <option value="1">ano - léčil/a</option> 
    </select>
    </div>

    <div class="col-sm-5">
    <label for="uzivatel">Zhoršuje se Váš stav v závislosti na změně počasí?</label>
    <select class="form-control" id="psychiatrie_zmena_pocasi" name="psychiatrie_zmena_pocasi">
    <option value="0">ne - nezhoršuje</option>
    <option value="1">ano - zhoršuje</option> 
    </select>
    </div>
    ...
    <label><input type="checkbox" name="psychika" value="1" id="psychika">Zobrazit typy problémů:</label> 
        ...
        <div id="dvpsychika" style="display: none">
            <div class="checkbox">
            <label><input type="checkbox" name="psychiatrie_deprese" value="1">Deprese</label> 
            </div>
            
            <div class="checkbox">
            <label><input type="checkbox" name="psychiatrie_nervozita" value="1">Nervozita</label> 
            </div>        
        
             <div class="checkbox">
            <label><input type="checkbox" name="psychiatrie_nespavost" value="1">Nespavost</label> 
            </div>       

            <div class="checkbox">
            <label><input type="checkbox" name="psychiatrie_nadmerne_poceni" value="1">Nadměrné pocení</label> 
            </div>
            
            <div class="checkbox">
            <label><input type="checkbox" name="psychiatrie_unavovy_syndrom" value="1">Únavový syndrom</label> 
            </div>
                    </div>
    </div>
</div>
...
<div class="row">
    ...
    <textarea class="form-control" id="leky_klasicke_mediciny" name="leky_klasicke_mediciny" placeholder="Uveďte léky klasické medicíny které užívate." rows="4" maxlength="250"></textarea>
    </div>
    </div>
    <br>
    </div>
...
//        $homeopatika_name = $row["homeopatika_id"].'_'.$homeopatika_name;
 ...
 //       $houby_name = $row["houby_id"].'_'.$houby_name; 
       $houby_name = $houby_name.'_'.$row["houby_id"];  
        ?>
        <div class="checkbox">
...
//        $inpharm_name = $row["inpharm_id"].'_'.$inpharm_name; 
        $inpharm_name = $inpharm_name.'_'.$row["inpharm_id"];
        ?>
        <div class="checkbox">
...
<div class="row">
    ...
    <select class="form-control" id="pitny_rezim" name="pitny_rezim_mnozstvi">
    <option value="1">do 0,5 litru</option> 
    <option value="2">do 1 litru</option>
    <option value="3">do 1,5 litru</option> 
    <option value="4">do 2 litrů</option>
    <option value="5">více než 2 litry</option>             
    </select>
    </div>
    
    <div class="col-sm-3">
    <label for="uzivatel">Kolikrát denně jíte?</label>
    <select class="form-control" id="jidlo" name="jidlo_mnozstvi">
    ...
    <option value="6">6x denně</option>                     
    <option value="7">více než 6x denně</option>
...
<div class="row">
    ...
    <input type="text"  class="form-control form-control-sm" name="spanek_v_kolik_hodin" maxlength="10" placeholder="Uveďte čas">
    </div> 
    </div>
...
<div class="row">
    ...
    <div class="row">
    <div class="col-sm-12">
    <textarea class="form-control" id="dve_onemocneni" name="dve_onemocneni" placeholder="Vyberte maximálně dvě onemocnění, které potřebujete vyřešit." rows="2" maxlength="250"></textarea>
    </div>
    </div>
    <br>
    </div>
