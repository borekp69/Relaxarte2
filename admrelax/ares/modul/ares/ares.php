...
// https://ares.gov.cz/ekonomicke-subjekty?ico=07440260

//$file = @file_get_contents("https://ares.gov.cz/ekonomicke-subjekty?ico=".$_POST["ico_ajax_send"]);
...
if($xml) 
  {
	...
	$ares_mesto_fin	= strval($el->AA->N);
        $ares_mesto_fin	= $ares_mesto_fin.'-'.strval($el->AA->NCO);
...
<div class="box_obsah box_kosik_ares" style="display: none;">
  ...
  ?>
      <div class="obal_radku_ares">
        ...
        <div class="radek_udaju_z_ares">
          <div class="nazev_udaje_z_ares">Ulice:</div>
          <div id="div_fakturacni_adresa" class="polozka_udaje_z_ares"><?php echo $ares_ulice_fin; ?></div>
          <div class="spacer"></div>
        </div>


        <div class="radek_udaju_z_ares">
          <div class="nazev_udaje_z_ares">ČP:</div>
          <div id="div_fakturacni_cp" class="polozka_udaje_z_ares"><?php echo $ares_cp1_fin; ?></div>
          <div class="spacer"></div>
        </div>


        <div class="radek_udaju_z_ares">
          <div class="nazev_udaje_z_ares">ČO:</div>
          <div id="div_fakturacni_co" class="polozka_udaje_z_ares"><?php echo $ares_cp2_fin; ?></div>
          <div class="spacer"></div>
        </div>
